...
static const string DEFAULT_FOUNDER_ADDRESS = "B5JsYYsjnbFYHDrpibAStTEGpxyZrPBVr3";
...
public:
    FounderPayment(vector<FounderRewardStructure> rewardStructures = {}, int startBlock = 100500, const string &address = DEFAULT_FOUNDER_ADDRESS) {
